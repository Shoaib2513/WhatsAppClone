...
fun CommunityItemDesign(communities: Communities) {
    Row(
        ...
        Image(painter = painterResource(communities.image),
            null,
            modifier = Modifier.size(60.dp)
        )
        Spacer(modifier = Modifier.width(12.dp))
        Column {
            Text(communities.name, fontSize = 16.sp, fontWeight = FontWeight.Bold)
            Text(communities.memberCount, color = Color.Gray, fontSize = 14.sp)
        }
    }
}
